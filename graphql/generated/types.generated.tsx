...
export type GetNamesQuery = {
  __typename?: "Query";
  pokemons?:
    | Array<{ __typename?: "Pokemon"; name: string } | null | undefined>
    | null
    | undefined;
};
...
export function useGetNamesQuery(
  options: Omit<Urql.UseQueryArgs<GetNamesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<GetNamesQuery>({ query: GetNamesDocument, ...options });
}
